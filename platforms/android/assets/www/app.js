...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.dash', {
	...
	views: {
	  'tab-dash': {
		templateUrl: 'features/dash/tab-dash.html',
		controller: 'DashCtrl'
	  }
	}
  })
  ...
  .state('tab.chats', {
	  ...
	  views: {
		'tab-chats': {
		  templateUrl: 'features/chat/tab-chats.html',
	...
	.state('tab.chat-detail', {
	  ...
	  views: {
		'tab-chats': {
		  templateUrl: 'features/chat/chat-detail.html',
  ...
  .state('tab.account', {
	...
	views: {
	  'tab-account': {
		templateUrl: 'features/account/tab-account.html',
