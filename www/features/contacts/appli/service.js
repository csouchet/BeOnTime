...
(function () {
    ...
    angular.module('org.beontime.features.contacts.appli.service', [])
        ...
        .factory('BeOnTimeContactsFactory', ['$rootScope', '$q', '$window', function ($rootScope, $q, $window) {
            ...
            function initQueryDB(tx) {
                ...
                'photo TEXT, phoneNumber TEXT, email TEXT, state TEXT, stateTime INTEGER, isFavorite Boolean)');
            }
            ...
            function deleteContact(contact) {
                var db = openDatabase();
                db.transaction(function (tx) {
                    tx.executeSql('DELETE FROM CONTACTS WHERE id = ?', [contact.id], function () {
                    }, errorCB);
                }, errorCB);
            }
